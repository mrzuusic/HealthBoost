...
@InputType()
class WorkoutCreateNestedManyWithoutDiaryEntriesInput {
...
export { WorkoutCreateNestedManyWithoutDiaryEntriesInput as WorkoutCreateNestedManyWithoutDiaryEntriesInput };
